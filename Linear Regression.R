...
hist(mod5a$residuals) # no skewness
qqPlot(mod5a$residuals)# qqplot looks okay
vif(mod5a) # No multicollinearity
...
#We can also take MAPE of two models on the validation data and compare to finalize the model
#But,validation is not a neccessary requirement for Linear model since meeting the assumptions means validating the model
